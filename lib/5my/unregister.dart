...
import 'package:wyyapp/5my/logic.dart';
                                ...
                                GetBuilder<MyLogic>(
                                  builder: (logic) {
                                    return Image.network(
                                      Get.find<MyLogic>().state.userDetail["backgroundUrl"] ?? "",
                                      fit: BoxFit.cover,
                                      width: Get.width,
        ...
        return Wrap(
          ...
          children: [
            ClipRRect(
              ...
              child: Get.find<MyLogic>().state.userDetail["avatarUrl"] == null
                  ? const Image(
                  ...
                  : Image.network(
                      Get.find<MyLogic>().state.userDetail["avatarUrl"],
                      width: 100,
                      height: 100,
                    ),
            ),
            Wrap(
              ...
              children: [
                Text(
                  Get.find<MyLogic>().state.userDetail["nickname"] ?? "未知",
            ...
            Wrap(
              ...
              alignment: WrapAlignment.center,
              children: [
                buildNumberShow("关注", controller.state.userDetail["followeds"]),
                buildNumberShow("粉丝", controller.state.userDetail["follows"]),
                //等级
                Container(
